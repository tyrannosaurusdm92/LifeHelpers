...
def psychiatry_background_analyze_text(text):
    """Passive scanner hook for callers that want ADHD + DBT + psychiatry context without changing the existing lambda handler."""
    return background_psychiatry_scanner.analyze_text(text or '')
