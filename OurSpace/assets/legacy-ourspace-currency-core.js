...
(function () {
  ...
  const CONFIG = Object.assign({
    ...
    announceToDom: true,
    allowedGameIds: window.OurSpaceAllowedGameIds || ["candycrush", "amongus", "angrybirds", "plantsvszombies", "fruitninja", "flappybird", "jetpackjoyride", "fnaf", "fnaf4", "fnaf2", "fnaf3", "fnafcustom", "badpiggies", "8ballclassic", "bubbleshooter", "doodlejump", "doodleroad", "paintbynumber", "fancypantsadventure2", "ducklife", "backrooms", "capybaraclicker", "minesweeper", "houseofhazards", "retropingpong", "bloxorz", "noobminer", "clashofvikings", "floodrunner2"],
  ...
  window.OurSpaceAllowedGameIds = window.OurSpaceAllowedGameIds || ["candycrush", "amongus", "angrybirds", "plantsvszombies", "fruitninja", "flappybird", "jetpackjoyride", "fnaf", "fnaf4", "fnaf2", "fnaf3", "fnafcustom", "badpiggies", "8ballclassic", "bubbleshooter", "doodlejump", "doodleroad", "paintbynumber", "fancypantsadventure2", "ducklife", "backrooms", "capybaraclicker", "minesweeper", "houseofhazards", "retropingpong", "bloxorz", "noobminer", "clashofvikings", "floodrunner2"];
  ...
  function getActiveProfile() {
    try {
      const rawV1 = localStorage.getItem(CONFIG.profileKey);
      if (rawV1) return JSON.parse(rawV1) || {};
    } catch (err) {}
    try {
      const id = localStorage.getItem('ourspace.activeProfile') || localStorage.getItem('ourspace.activeProfile.v1') || '';
