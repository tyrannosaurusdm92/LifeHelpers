/* OurSpace Play-to-Win Private Currency Adapter v2.1
   Converts imported GitHub play-to-earn / wallet / NFT style calls into private OurSpace in-site currency.
   Important: mobile-game rewards are allowed only for the 29 OurSpace game IDs, including external fallback-minute-tracked entries from json/ourspace_allowed_game_ids.json:
   candycrush, amongus, angrybirds, plantsvszombies, fruitninja, flappybird, jetpackjoyride, fnaf, fnaf4, badpiggies, 8ballclassic, bubbleshooter, doodlejump, paintbynumber, fancypantsadventure2, ducklife, backrooms, capybaraclicker, minesweeper, houseofhazards, retropingpong, bloxorz, noobminer, clashofvikings, floodrunner2
*/
(function () {
  'use strict';
  ...
  const ALLOWED_GAME_IDS = new Set(["candycrush", "amongus", "angrybirds", "plantsvszombies", "fruitninja", "flappybird", "jetpackjoyride", "fnaf", "fnaf4", "fnaf2", "fnaf3", "fnafcustom", "badpiggies", "8ballclassic", "bubbleshooter", "doodlejump", "doodleroad", "paintbynumber", "fancypantsadventure2", "ducklife", "backrooms", "capybaraclicker", "minesweeper", "houseofhazards", "retropingpong", "bloxorz", "noobminer", "clashofvikings", "floodrunner2"]);
