...
Backend script files are not bundled in this front-end package. Cart and receipt purchase submission still uses the configured stable site backend library URL.
